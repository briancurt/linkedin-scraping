...
def tomonths(a):
	...
	#only have 2 or 4 words: if 2, it's either number of months or number of years, so check which word
	#it contains, do the math and return months. If 4, it's years with months, so just do the math and return.
